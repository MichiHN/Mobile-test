class Gallery {
    ...
    // You can also adjust other UI elements here if needed
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            artUploadForm.addEventListener("submit", (event) => {
                ...
                if (files.length > 0) {
                    // Call the method to add the artwork to the gallery
                    gallery.addImagesFromFileInput(files);
        
                    // Provide feedback to the user
                    alert("Your art has been submitted and added to the gallery!");
                } else {
